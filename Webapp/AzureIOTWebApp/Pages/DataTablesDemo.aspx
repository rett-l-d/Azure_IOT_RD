<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataTablesDemo.aspx.cs" Inherits="AzureIOTWebApp.Pages.DataTablesDemo" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            var table = new DataTable('#mainGrid', {
                ...
                "ajax": {
                    url: 'DataTablesDemo.aspx/BindTelemetryData',
